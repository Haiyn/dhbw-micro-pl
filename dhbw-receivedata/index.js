...
app.post('/values',  async(req, res) =>{
    ...
    await axios.post('http://' + process.env.EVENTBUS_HOST + ':' + process.env.EVENTBUS_PORT + '/events', {
...
app.listen(process.env.RECEIVEDATA_PORT, () =>{
    console.log('Listening on ' + process.env.RECEIVEDATA_HOST + ' on port ' + process.env.RECEIVEDATA_PORT)
});